                            ...
                            {trendingTopics.map((topic) => (
                                <div key={topic.category} className="my-2">
                                    <div className="flex gap-4 content-center">
                                        <Image src={topic.img} alt={topic.category} width={50} height={40} />
                                        <div className="flex flex-col gap-2 p-1">
                                            <h5 className="font-bold text-md content-center">{topic.category}</h5>
                                            <p className="text-sm text-gray-500 content-center">{topic.counter} Articles</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="flex flex-col gap-2">
                            {authors.map((author) => (
                                <div key={author.name} className="my-2">
                                    <div className="flex gap-4 content-center">
                                        <Image src={author.img} alt={author.name} width={50} height={40} />
                                        <div className="flex flex-col gap-2">
                                            <h5 className="font-bold text-md content-center">{author.name}</h5>
                                            <p className="text-sm text-gray-500 content-center">{author.field}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
                                ...
                                <div key={post.topic} className="my-2">
                                    <div className="flex gap-4 content-center justify-between">
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <h3 className="font-bold text-md content-center">{post.topic}</h3>
                                        </div>
                                        <div className="flex">
