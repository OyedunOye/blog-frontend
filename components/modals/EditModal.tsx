  ...
  return (
    <div className="fixed top-0 left-0 bg-black/80 w-full h-full z-[50]">
      <div className="w-full h-full flex content-center justify-center">
        ...
        <MaxWidth className="w-200 max-lg:w-180 max-md:w-[90%] max-md:mx-1 py-10 h-[80%] my-auto justify-center bg-white border content-center dark:bg-slate-800 rounded-lg overflow-y-auto overflow-x-hidden">
          <div className="flex content-end justify-end relative h-10 p-1 mt-5 -mb-4 w-full -right-3 top-6 cursor-pointer">
            <CircleXIcon size={30} onClick={handleClickBack} />
          </div>
