    ...
    <div className="flex flex-col">
      ...
      <MaxWidth className="h-fit py-10 w-3/4 max-lg:w-[88%] max-md:w-[95%] justify-center relative -top-24 bg-white dark:bg-slate-900 border rounded-lg shadow-md">
        <div className="gap-4">
          ...
          <h2 className="my-2 font-bold">Interpretation and Definitions</h2>
            ...
            <li>
              <p>
                ...
                <a
                  ...
                  className="underline text-blue-600"
                >
                  https://blog-frontend-pi-blush.vercel.app/
                </a>
              </p>
            </li>
            <li>
          ...
          <h3 className="font-semibold mt-3">Types of Data Collected</h3>
          <h4>Personal Data</h4>
          <p>
          ...
          <h3 className="mt-3 font-semibold">Delete Your Personal Data</h3>
          <p>
          ...
          <h4 className="mt-3">Business Transactions</h4>
          <p>
          ...
          <h4 className="mt-3">Other legal requirements</h4>
          <p>
          ...
          <h3 className="mt-3 font-semibold">Security of Your Personal Data</h3>
          <p>
          ...
          <h2 className="mt-3 font-semibold">Changes to this Privacy Policy</h2>
          <p>
          ...
          <ul>
            <li>
              ...
              <a
                className="underline text-blue-600"
                href="mailto:shadesblogapp@gmail.com"
              >
                shadesblogapp@gmail.com
              </a>
              .
            </li>
          </ul>
